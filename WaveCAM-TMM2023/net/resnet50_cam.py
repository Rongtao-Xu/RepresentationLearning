...
class Net(nn.Module):
    def __init__(self, stride=16, n_classes=20):
        ...
        self.bg = nn.Conv2d(2048, n_classes, 1, bias=False)
        self.backbone = nn.ModuleList([self.stage1, self.stage2, self.stage3, self.stage4])
        self.newly_added = nn.ModuleList([self.classifier])

        # self.wave = PATM(2048, qkv_bias=False, qk_scale=None, attn_drop=0., mode='fc')
...
class Net_CAM_Feature(Net):
    ...
    def forward(self, x):
        ...
        return x, cams_feature, cams, cams
...
from net.wavecam import WaveModeling
...
class Class_Predictor_wavecam(nn.Module):
    def __init__(self, num_classes, representation_size):
        ...
        self.wave = WaveModeling(20, qkv_bias=False, qk_scale=None, attn_drop=0., mode='fc')
    ...
    def forward(self, x, label, cams):
        ...
        feature = feature.view(batch_size, 20, -1)
