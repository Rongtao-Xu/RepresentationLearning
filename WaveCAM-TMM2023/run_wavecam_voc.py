...
if __name__ == '__main__':
    ...
    parser.add_argument("--cam_num_epoches", default=0, type=int) 
    ...
    parser.add_argument("--wavecam_loss_weight", default=1.0, type=float)

    # Mining Inter-pixel Relations
    parser.add_argument("--conf_fg_thres", default=0.35, type=float) #0.35
    parser.add_argument("--conf_bg_thres", default=0.1, type=float) #0.1
    ...
    parser.add_argument("--exp_times", default=8,
                        help="Hyper-parameter that controls the number of random walk iterations,"
                             "The random walk is performed 2^{exp_times}.") #8
    ...
    if args.train_wavecam_pass is True:
        import step.train_wavecam

        timer = pyutils.Timer('step.train_wavecam:')
        step.train_wavecam.run(args)
    ...
    if args.make_wavecam_pass is True:
        import step.make_wavecam

        timer = pyutils.Timer('step.make_wavecam:')
        step.make_wavecam.run(args)
