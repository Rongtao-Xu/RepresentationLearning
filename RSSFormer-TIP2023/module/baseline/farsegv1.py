...
@er.registry.MODEL.register('FarSegV1Plus')
class FarSegV1(er.ERModule):
    # FarSegV1: ResNet + FPN + FSR + (normalized focal losses)
    # FarSegV1plus: ResNet v1d + PPM + FPN + Improved FSR + (normalized focal losses)
