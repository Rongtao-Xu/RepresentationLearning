...
def coco2voc(anns_file, target_folder, n=None, compress=True):
    ...
    for i, img in enumerate(coco_imgs):
        ...
        Image.fromarray(class_seg).convert("L").save(class_target_path + '/' + 'COCO_train2014_'+ str(img).zfill(12) + '.png')
        Image.fromarray(instance_seg).convert("L").save(instance_target_path + '/' + 'COCO_train2014_'+ str(img).zfill(12) + '.png')
        ...
        image_id_list.write('COCO_train2014_'+ str(img).zfill(12)+'\n')
