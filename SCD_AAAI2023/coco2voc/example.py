...
if __name__ == '__main__':
    ...
    annotations_file = '/data/coco/annotations/instances_train2014.json'
    labels_target_folder = '/data/coco/SegmentationClass/train_coco2voc'
    data_folder = '/data/coco/JPEGImages/train'

    #82783
    # Convert n=25 annotations
    coco2voc(annotations_file, labels_target_folder, n=82782, compress=True)
    ...
    for id in id_list:
        ...
        img_ann = coco.loadImgs(int(str(id).split('_')[-1]))
